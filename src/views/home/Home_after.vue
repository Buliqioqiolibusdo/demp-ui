<template>
  <div class="home">
    ...
    <el-row class="row-line-chart">
      <LineChart :config="dailyConfig" is-time-series label-key="date" />
    </el-row>
  ...
  setup() {
    ...
    const metrics = ref<MetricMeta[]>([
      ...
      },
      {
        ...
        path: "/tasks",
        color: (m: MetricMeta) =>
          m.value > 0 ? variables.dangerColor : variables.successColor,
      },
      {
        name: "Total Results",
        icon: ["fa", "table"],
        ...
        value: 0,
        color: (m: MetricMeta) =>
          m.value > 0 ? variables.successColor : variables.infoMediumColor,
      },
      {
        name: "Users",
        icon: ["fa", "users"],
    ...
    const dailyConfig = ref<EChartsConfig>({
      ...
      option: {
        ...
        color: [variables.primaryColor, variables.successColor],
      },
    });
